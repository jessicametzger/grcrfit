...
# -------------------------------------------
# edit this stuff
datname='./gamma_fluxes.dat'
delimiter=','
USINEname='./gammadatabase.USINE'
info={'quantity':'gamma',
...
data=np.array([x.split(delimiter) for x in data]).astype(np.float)

# assuming energies are given in MeV; converting to GeV
data[:,0:2] = data[:,0:2]/1000.
d=datetime.datetime.today()

# assuming gamma ray emissivities have been multiplied by 1e24
